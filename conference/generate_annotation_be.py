#!/usr/bin/env python3
"""
Generate Belarusian annotation for CTDA 2024 article.

Output: annotation_be.docx
"""
...
OUTPUT_PATH = os.path.join(PROJECT_ROOT, 'annotation_be.docx')
...
def main():
    print('[*] Generating Belarusian annotation...')
    doc = Document()
    setup_styles(doc)
    ...
    # Author
    doc.add_paragraph('І. І. Іваноў', style='Автор')
    ...
    print(f'[+] Done! Belarusian annotation saved: {OUTPUT_PATH}')
